...
a. `co2` is tidy data: it has one year for each row. #I think there is one year per row so it's tidy
...
a.  `ChickWeight` is not tidy: each chick has more than one row. #I think this is the case
